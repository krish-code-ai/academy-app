    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('site/images/logo.png') }}" alt=" Logo" style="max-width: 80px;"></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item cta"><a href="#" class="nav-link"><span>Register Now!</span></a></li>
                </ul>
            </div>
        </div>
    </nav>
